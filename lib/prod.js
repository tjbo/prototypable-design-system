...
var ButtonUI = styled('button')(_templateObject$1(), config.colors.dark2, config.fonts.font2, config.unit(0.75), config.unit(1.75), config.unit(0.66), function (_ref) {
...
var DefaultLink = function DefaultLink(href, button) {
...
function button (_ref) {
  var align = _ref.align,
      ...
      _ref$Link = _ref.Link,
      Link = _ref$Link === void 0 ? DefaultLink : _ref$Link;
  var Button = /*#__PURE__*/React.createElement(ButtonUI, {
    align: align,
