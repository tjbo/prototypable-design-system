...
var index = require('./index-a67e3afd.js');
require('react-is');
require('react-breakpoints');
require('react-input-slider');
require('react-jsx-parser');
require('react-element-to-jsx-string');
require('prismic-javascript');

function _templateObject() {
  var data = index._taggedTemplateLiteral(["\n  fill: ", ";\n  animation: ", ";\n"]);
...
var pulseColor = function pulseColor(_style) {
  return styled.keyframes(["to{fill:", ";}from{fill:", ";}"], _style === 'light' ? '#fff ' : '#000', _style === 'light' ? '#000' : '#fff');
};

var AnimateFillUI = styled__default('path')(_templateObject(), function (_ref) {
...
var Logo = /*#__PURE__*/function (_React$Component) {
  index._inherits(Logo, _React$Component);

  var _super = index._createSuper(Logo);

  function Logo(props) {
    var _this;

    index._classCallCheck(this, Logo);
