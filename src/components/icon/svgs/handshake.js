...
export default function (props) {
  return (
    <Icon viewBox="0 0 508 508" {...props}>
      ...
      />
      <g fill="#324a5e">
        <path d="M188.4 162L148 126.4c-3.6-3.2-8.8-2.8-12 .8l-70.8 80c-3.2 3.6-2.8 8.8.8 12l40.4 35.6c3.6 3.2 8.8 2.8 12-.8l70.8-80c3.2-3.2 2.8-8.8-.8-12zM138.4 259.6l-18 13.6c-8 6-10.8 17.6-4.8 26s18 10.4 26 4.4l6.8-4.8c.4-.4 1.2-.8 1.6-1.2l10.8-8c8.8-6.4 10-19.6 2-27.6l-.4-.4c-6.4-6.4-16.8-7.2-24-2zM180 320.8l6.8-4.8c9.2-6.8 10-20 2-27.6-6.4-6.4-16.8-7.2-24-1.6l-16.4 12.4c-7.6 6.8-8 18.8-.8 26.4 6.4 6.8 17.2 7.2 24.8 1.6l6-4.4c.8-1.2 1.2-1.6 1.6-2z" />
        <path d="M150 297.2c-.4.4-1.2.8-1.6 1.2l1.6-1.2zM210.4 344l2.8-2c9.2-6.8 10-20 2-27.6-6.4-6.4-16.8-7.2-24-1.6l-12.8 9.2c-7.6 6.8-8 18.8-.8 26.4 6.4 6.8 17.2 7.2 24.8 1.6l6-4.4c.8-.4 1.2-1.2 2-1.6z" />
        <path d="M180 320.8c-.4.4-1.2.8-1.6 1.2l1.6-1.2zM208.8 345.6c-7.6 6.8-8 18.8-.8 26.4 6.4 6.8 17.2 7.2 24.8 1.6l6.8-4.8c9.2-6.8 10-20 2-28-6.4-6.4-16.8-7.2-24-1.6l-8.8 6.4z" />
      </g>
